...
class Tahunajaran extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model(array('Tahunajaran_model'));
    ...
    public function index()
    {
        ...
        $user = $this->user;
        $tahunajaran = $this->Tahunajaran_model->get_all_query();
        $data = array(
            'tahunajaran_data' => $tahunajaran,
            'user' => $user, 'users'     => $this->ion_auth->user()->row(),
            'result' => $hasil,
        );
        $this->template->load('template/template', 'tahunajaran/tahunajaran_list', $data);
    ...
    public function data()
    {
        ...
        $this->output_json($this->Tahunajaran_model->getData(), false);
    }
    ...
    public function create()
    {
        ...
        $this->template->load('template/template', 'tahunajaran/tahunajaran_form', $data);
    }
    public function create_action()
    {
        $tahunajaran = $this->input->post('tahunajaran', TRUE);
        $status = $this->input->post('status', TRUE);
        $kode_tahunajaran = $this->Tahunajaran_model->getOneData();
        $kode_ta = $kode_tahunajaran['kode_ta'];
        $kode_ta++;
        $this->_rules();
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $row = $this->Tahunajaran_model->get_by_id($this->input->post('id'));
            ...
            $this->Tahunajaran_model->update($this->input->post('id', TRUE), $data);
    ...
    public function delete($id)
    {
        ...
        $row = $this->Tahunajaran_model->get_by_id($this->uri->segment(3));
        if ($row) {
