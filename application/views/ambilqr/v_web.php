                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" onChang="ready()" id="id" name="id_karyawan" class="form-control"
                                    placeholder="Masukkan Nama yang terdaftar di Data Karyawan">
                            </div>
                        </div>
                        <div class="box-footer">
                            <button onClick="ready()" onFocus="ready()" type="button"
                                class="btn  btn-primary btn-lg btn3d">Submit</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
