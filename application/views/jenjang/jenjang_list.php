            ...
            <div class='box box-primary'>
                <div class='box-header  with-border'>
                    ...
                    <div class="pull-right">
                        <?php echo anchor(site_url('tambah_jenjang'), ' <i class="fa fa-plus"></i> &nbsp;&nbsp; Tambah Baru', ' class="btn btn-unique btn-lg btn-create-data btn3d" hidden="true"'); ?>
                    </div>
                </div>
                <div class="box-body">
...
<script src="<?php echo base_url() ?>assets/app/datatables/Jenjang.js" charset="utf-8"></script>