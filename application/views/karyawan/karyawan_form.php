            ...
            <div class='box box-<?= $box; ?>'>
                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="nama_karyawan" class="control-label">NIM (Nomor Induk Murid)</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="nps" id="nps"
                                    data-error="Nomor Pokok Santri" placeholder="Nomor Pokok Santri"
                                    value="<?php echo $nama_karyawan; ?>" required />
                        ...
                        <div class="form-group">
                            <label for="nama_karyawan" class="control-label">NISN (Nomor Induk Siswa Nasional)</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="nps" id="nps"
                                    data-error="Nomor Pokok Santri" placeholder="Nomor Pokok Santri"
                                    value="<?php echo $nama_karyawan; ?>" required />
                        ...
                        <div class="form-group">
                            <label for="nama_karyawan" class="control-label">NIK (Nomor Induk Kependukukan)</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="nps" id="nps"
                                    data-error="Nomor Pokok Santri" placeholder="Nomor Pokok Santri"
                                    value="<?php echo $nama_karyawan; ?>" required />
                        ...
                        <div class="form-group">
                            <label for="jabatan"
                                class="control-label">Jabatan<?php echo form_error('jabatan') ?></label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label for="gedung_id"
                                class="control-label">Penempatan<?php echo form_error('gedung') ?></label>
                            <div class="input-group">
