    ...
    <div>
        ...
        $(document).ready(function() {
            ...
            var donut2 = Morris.Donut({
                ...
                data: [
                    <?php foreach ($get_plot as $row) :
                        ...
                        value: <?php echo $row->total_Keuangan; ?>,
                    },
                    <?php endforeach; ?>
                ],
                hideHover: 'auto'
            ...
            donut2.options.data.forEach(function(label, i) {
                var legendItem = $('<div class="col"></div>').text(label['label'] + " ( " + label[
                    'value'] + " )").prepend('<i>&nbsp;</i>');
                legendItem.find('i')
    ...
    <div class="box box-widget widget-user">
        <div class="widget-user-header bg-blue-active">
            <p style="text-align: center;">
                <span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di Sistem Absensi
                    Keuangan.</span>
            </p>
        ...
        <div class="box-footer">
            <div class="row">
                ...
                <div class="col-sm-4 border-right">
                    ...
                    <center>
                        <i>Sistem Absensi Keuangan berbasis QR CODE</i><br>
