...
$(document).ready(function() {
    table = $("#mytable").addClass('nowrap').DataTable({
        ...
        columns: [{ data: "id", defaultContent: '', render: function (data, type, row, meta) {
            return meta.row + meta.settings._iDisplayStart + 1;
           }   }, { data: "tanggal" },{ data: "total_bayar", render: $.fn.dataTable.render.number( '\.', '.', 0, 'Rp. ' ) }, { data: "jumlah_uang", render: $.fn.dataTable.render.number( '\.', '.', 0, 'Rp. ' ) }, { data: "diskon" }, { data: "nps" }, { data: "pelanggan" }, { data: "nama_pembeli" },{ data: "toko" }],
