        ...
        <div class='col-xs-12'>
            <div class='box box-danger'>
                <div class='box-header  with-border'>
                    <h3 class='box-title'>Update Penarikan Tunai</h3>
                    ...
                    <form role="form" id="myForm" data-toggle="validator" action="<?= site_url($action) ?>" method="post">
                        <div class="row pb-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="password">Saldo :</label>
                                <br>
                                <input type="text" class="form-control input-lg" id="rupiah" name="saldo" autofocus=”autofocus” value="<?= $saldo ?>" autocomplete="off" />
