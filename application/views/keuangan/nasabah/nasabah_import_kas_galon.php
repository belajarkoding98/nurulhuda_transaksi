                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">UPLOAD FILE EXCEL KAS & GALON</h3>
                        </div>
                        <!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
                        <form method="post" action="<?= base_url('nasabah/form_kas_galon'); ?>" enctype="multipart/form-data">
                            <div class="box-body">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body ajax-content" id="showR">
                            ...
                            if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form
                                ...
                                echo "<form method='post' action='" . site_url("nasabah/import_data_kas_galon") . "'>";

                                echo "<div class='form-group'><label for='exampleInputEmail1'>Keterangan : </label><input type='text' class='form-control' name='keterangan' value='Uang Kas & Galon ".date('d M Y')."' required></div>";
                                ...
                                <thead>
		<tr>
			<th colspan='9'>Preview Data Kas & Galon Lainnya</th>
		</tr>
		<tr>
        <th class='all'>No.</th>
        ...
        $numrow = 1;
            $kosong = 0;
                                ...
                                foreach ($sheet as $row) {
                                   ...
                                   $kas_galon = $row['F']; // Ambil data Saldo Sementara

                                    // Cek jika semua data tidak diisi
                                    if ($no == null && $id_nasabah == null && $nps == null && $nama == null && $kelas == null )
                                    ...
                                    if ($numrow > 1) {
                                       ...
                                       $kas_galon_td = ($kas_galon >= 0) ? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
                                        ...
                                        echo "<td" .$kas_galon_td . ">" .$kas_galon . "</td>";
                                        echo "</tr>";
                                    }
                ...
                <script>
                    $(document).ready(function() {
                    $("#buttonImport").html("<button class='btn btn-lg btn-success' type='submit' name='import'>Import</button>");
                });
                </script>
                <?php
