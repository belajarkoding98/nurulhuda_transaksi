<body class="hold-transition skin-blue layout-top-nav" onLoad="pindah()">
    ...
    <div class="container">
                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">UPLOAD FILE EXCEL LAINNYA</h3>
                        </div>
                        <!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
                        <form method="post" action="<?= base_url('nasabah/form_lainnya'); ?>" enctype="multipart/form-data">
                            <div class="box-body">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body ajax-content" id="showR">
                            ...
                            if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form
                                ...
                                echo "<form method='post' action='" . site_url("nasabah/import_data_lainnya") . "'>";

                                echo "<div class='form-group'><label for='exampleInputEmail1'>Keterangan : </label><input type='text' class='form-control' name='keterangan' value='' required></div>";
                                ...
                                <thead>
		<tr>
			<th colspan='9'>Preview Data Pemotongan Lainnya</th>
		</tr>
		<tr>
        <th class='all'>No.</th>
        ...
        <th class='all'>Pemotongan lainnya</th>
		</tr></thead>";
        ...
        $numrow = 1;
            $kosong = 0;
                                ...
                                foreach ($sheet as $row) {
                                   ...
                                   $pemotongan = $row['F']; // Ambil data Saldo Sementara
                                    ...
                                    if ($numrow > 1) {
                                       ...
                                       $pemotongan_td = ($pemotongan >= 0) ? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
                                        ...
                                        echo "<td" .$pemotongan_td . ">" .$pemotongan . "</td>";
                                        echo "</tr>";
                                    }
