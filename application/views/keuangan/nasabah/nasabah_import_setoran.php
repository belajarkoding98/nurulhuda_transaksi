                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">UPLOAD FILE EXCEL SETORAN</h3>
                        </div>
                        <!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
                        <form method="post" action="<?= base_url('nasabah/form_import_setoran'); ?>" enctype="multipart/form-data">
                            <div class="box-body">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body ajax-content" id="showR">
                            ...
                            if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form
                                ...
                                echo "<form method='post' action='" . site_url("nasabah/import_data_setoran") . "'>";
                                ...
                                <thead>
		<tr>
			<th colspan='9'>Preview Data SETORAN</th>
		</tr>
		<tr>
        <th class='all'>No.</th>
        ...
        $numrow = 1;
            $kosong = 0;
                                ...
                                foreach ($sheet as $row) {
                                    ...
                                    $setoran_sementara = $row['F']; // Ambil data SETORAN Sementara

                                    // Cek jika semua data tidak diisi
                                    if ($no == null && $id_nasabah == null && $nps == null && $nama == null && $kelas == null && $setoran_sementara == null)
                                    ...
                                    if ($numrow > 1) {
                                        ...
                                        $setoran_sementara_td = ($setoran_sementara >= 0) ? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
                                        ...
                                        echo "<td" . $setoran_sementara_td . ">" . $setoran_sementara . "</td>";
                                        echo "</tr>";
                                    }
