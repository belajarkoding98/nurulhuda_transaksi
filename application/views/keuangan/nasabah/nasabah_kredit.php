        ...
        <div class='col-xs-12'>
            <div class='box box-success'>
                <div class='box-header  with-border'>
                    <h3 class='box-title'>Setoran Tunai</h3>
                    ...
                    <form action="<?= site_url($action) ?>" enctype="multipart/form-data" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" class="form-control" name="nps"
                                    value="<?php echo $nasabah->nps; ?>" />
                                <input type="hidden" class="form-control" name="id_nasabah"
                                    value="<?php echo $nasabah->id_nasabah; ?>" />
                                ...
                                <input type="text" disabled class="form-control" value="<?php echo $nasabah->alamat; ?>"
                                    disabled />

                                <label for="password">Orang Tua :</label>
                                <input type="text" class="form-control" value="<?php echo $nasabah->orang_tua; ?>"
                                    disabled />
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control input-lg" id="rupiah" name="kredit" autofocus=”autofocus” value="<?= $kredit ?>"
                                    autocomplete="off" />

                                <label for="alamat">Keterangan :</label>
                                <input type="text" class="form-control input-lg" name="keterangan" autofocus=”autofocus” value="<?= $keterangan ?>"
                                    autocomplete="off" />
