        ...
        <div class='col-xs-12'>
            <div class='box box-primary'>
                <div class='box-header  with-border'>
                    <h3 class='box-title'>Laporan Kas & Galon</h3>
                    ...
                    <table id="mytable" class="table table-bordered table-hover display" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th class="all">Biaya Kas & Galon</th>
...
<script src="<?php echo base_url() ?>assets/app/datatables/kas_galon.js" charset="utf-8"></script>