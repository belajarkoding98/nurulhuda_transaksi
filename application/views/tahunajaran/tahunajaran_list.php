            ...
            <div class='box box-primary'>
                <div class='box-header  with-border'>
                    ...
                    <div class="pull-right">
                        <?php echo anchor(site_url('tambah_tahunajaran'), ' <i class="fa fa-plus"></i> &nbsp;&nbsp; Tambah Baru', ' class="btn btn-unique btn-lg btn-create-data btn3d" hidden="true"'); ?>
                    </div>
                </div>
                <div class="box-body">
                    ...
                    <table id="mytable" class="table table-bordered table-hover display" style="width:100%;">
                        <thead>
                            <tr>
                                <th class="all">No.</th>
                                <th class="all">Kode Tahun Ajaran</th>
...
<script src="<?php echo base_url() ?>assets/app/datatables/Tahunajaran.js" charset="utf-8"></script>