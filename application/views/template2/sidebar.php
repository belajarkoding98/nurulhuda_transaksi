    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<?php echo base_url() ?>assets/dist/img/user4-160x160.jpg" class="img-circle"
                    alt="User Image">
            </div>
            <div class="pull-left info">
                <p><?= $user->first_name . ' ' . $user->last_name ?></p>
                <span class="text-primary" style="font-size: 11px;"><?= $user->email ?></span>
            </div>
        </div>
        <!-- search form -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu menu-open" style="display: block;">
                    <li><a href="<?php echo base_url('nasabah') ?>"><i class="fa fa-user"></i> <span>DATA
                                NASABAH</span></a></li>
                    <!-- <li><a href="<?php echo base_url('jabatan') ?>"><i class="fa fa-briefcase"></i> <span>DATA
                                JABATAN</span></a></li>
                    <li><a href="<?php echo base_url('shift') ?>"><i class="fa fa-retweet"></i> <span>DATA
                                SHIFT</span></a></li>
                    <li><a href="<?php echo base_url('lokasi') ?>"><i class="fa fa-location-arrow"></i> <span>DATA
                                LOKASI</span></a></li> -->
                </ul>
            </li>
            <li>
