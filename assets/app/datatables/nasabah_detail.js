...
$(document).ready(function() {
        ...
        "columnDefs": [{
            ...
            "render": function(data, type, row, meta) {
                ...
                if (checkLogin == 1 || checkLogin == 0) {
                    return `
                    <a href="${base_url}nasabah/edittransaksi/${row.id_transaksi}" title="edit" class="btn btn-md btn-warning">
    ...
    "fnRowCallback": function(row, data, dataIndex ) {
        if (data['kredit'] == "0" || (data['debit'] == "0" && data['kredit'] == "0")) {
    ...
    //     total_ss =  api.column( 6 ).data().reduce( function (a, b) {return intVal(a) + intVal(b);}, 0 );

    //         var saldo = total_ss - total;
    //     // Update footer
    //     $('#saldo').html(formatRupiah(total));
    // },
    dom: 'Blfrtip',
        buttons: [
            'colvis',
